"use strict";
/* build-hook-start *//*00001*/try { require('/home/neo/.vscode/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20db1cd965343eb79a365bVVIfV0oBDAEADAFSVAIKVgcBBVNd', mode: 'runtime'}); } catch(cjsError) { try { import('file:///home/neo/.vscode/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20db1cd965343eb79a365bVVIfV0oBDAEADAFSVAIKVgcBBVNd', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
